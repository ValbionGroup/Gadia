...
class CreateElevesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('eleves', function (Blueprint $table) {
            ...
            $table->integer('psc1', 1)->nullable();
            $table->integer('assn', 1)->nullable();
            $table->integer('gqs', 1)->nullable();
            $table->integer('aper', 1)->nullable();
            $table->integer('assr1', 1)->nullable();
            $table->integer('assr2', 1)->nullable();
            $table->integer('aps', 1)->nullable();
