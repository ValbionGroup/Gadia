                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <label class="block text-sm mb-2">
                                ...
                                <input disabled
                                    class=" cursor-not-allowed block w-full mt-1 text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-800 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    type="text" name="name" value="{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}" autocomplete="name" />
                            </label>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <label class="block text-sm mb-2">
                                ...
                                <input
                                    ...
                                    type="email" name="email" value="{{ Auth::user()->email }}" autocomplete="email" required />
                            </label>
                        </div>
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <label class="block text-sm mb-2">
                                ...
                                <input
                                    class="block w-full mt-1 text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-800 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    type="tel" name="tel" value="{{ $tel }}" autocomplete="tel" />
                            </label>
                        </div>
                        @endif
