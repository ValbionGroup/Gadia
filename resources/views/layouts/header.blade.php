        ...
        <div class="flex justify-center flex-1 lg:mr-32">
            <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                ...
                <input
                    ...
                    type="text" placeholder="Rechercher une information" aria-label="Search" />
            </div>
        </div>
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li class="relative">
                <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                    ...
                    aria-haspopup="true">
                    <img class="object-cover w-8 h-8 rounded-full" src="{{ 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->first_name . ' ' . Auth::user()->last_name).'&color=7E3AF2&background=EBF4FF'  }}" alt="{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}"
                        aria-hidden="true" />
                </button>
