...
<tr class="text-gray-700 dark:text-gray-400">
    <td class="px-4 py-3">
        <div class="flex items-center text-sm">
            <div>
                <p class="font-semibold">Du 5 juil. à 8h00 au 6 juil. à 17h00</p>
            </div>
        </div>
    </td>
...
<tr class="text-gray-700 dark:text-gray-400">
    <td class="px-4 py-3">
        <div class="flex items-center text-sm">
            <div>
                <p class="font-semibold">Du 1 juil. à 9h00 au 1 juil. à 12h00</p>
            </div>
        </div>
    </td>
    <td class="px-4 py-3 text-sm">
...
<tr class="text-gray-700 dark:text-gray-400">
    <td class="px-4 py-3">
        <div class="flex items-center text-sm">
            <div>
                <p class="font-semibold">Du 15 juin à 13h30 au 15 juin à 17h30</p>
            </div>
        </div>
    </td>
    <td class="px-4 py-3 text-sm">
