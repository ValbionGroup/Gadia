                ...
                <div class="container grid px-6 mx-auto">
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            ...
                            <div>
                                <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                                    Total d'heures manquées
                                </p>
                                <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                                    {{ $total_heures }}<span class="text-xs font-medium">h</span> manquées
                                </p>
                            </div>
                        </div>
                        <!-- Card -->
                            ...
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3" style="width: 1px; white-space: nowrap;">H. Cours</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    @include('eleve.modules.viescolaire.table.abs')
                                </tbody>
                            </table>
                        </div>
                        <div
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                        <th class="px-4 py-3" style="width: 1px; white-space: nowrap;">Type</th>
                                        <th class="px-4 py-3" style="width: 1px; white-space: nowrap;">Date</th>
                                        <th class="px-4 py-3" style="width: 1px; white-space: nowrap;">Demandé(e) le
                                        </th>
                                        <th class="px-4 py-3" style="width: 1px; white-space: nowrap;">Demandé(e) par
                                        </th>
                                        <th class="px-4 py-3" style="white-space: nowrap;">Motif</th>
                                        <th class="px-4 py-3" style="white-space: nowrap;">Détail des circonstances</th>
                                        <th class="px-4 py-3" style="white-space: nowrap;">Travail à faire</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            Aucune sanction n'a été enregistré. Continue comme ça 👍
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            Aucun passage n'a été enregistré. Continue comme ça 👍
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
