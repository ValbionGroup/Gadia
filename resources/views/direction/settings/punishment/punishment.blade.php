...
@section('title')
Gestion sanctions
<?php $page_name = "Gestion sanctions" ?>
@endsection
            ...
            <div class="px-4 py-5 bg-white dark:bg-gray-700 sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                ...
                @endif
                    ...
                    <div class="flex flex-col sm:flex-row mb-4 text-gray-600 dark:text-gray-300">
                        <button onclick="openTab(event, 'motifs')" class="text-sm uppercase font-light flex-1 tablinks inline-block border-b-2 text-purple-500 border-purple-500 dark:text-purple-400 dark:border-purple-400 focus:outline-none py-2 px-4">
                            Motifs
                        </button>
                        <button onclick="openTab(event, 'punitions')" class="text-sm uppercase font-light flex-1 tablinks inline-block hover:text-purple-500 dark:hover:text-purple-400 focus:outline-none py-2 px-4">
                            Punitions
                        </button>
                        <button onclick="openTab(event, 'sanctions')" class="text-sm uppercase font-light flex-1 tablinks inline-block hover:text-purple-500 dark:hover:text-purple-400 focus:outline-none py-2 px-4">
                            Sanctions
                        </button>
                </div>
                {{-- @include() --}}
