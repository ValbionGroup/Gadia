...
@section('title')
Gestion absences et appels
<?php $page_name = "Gestion absences et appels" ?>
@endsection
            ...
            <div class="px-4 py-5 bg-white dark:bg-gray-700 sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                ...
                @endif
                    ...
                    <div class="flex flex-col sm:flex-row mb-4 text-gray-600 dark:text-gray-300">
                        <button id="absences" onclick="openTab(event, 'absences')" class="text-sm uppercase font-light flex-1 tablinks inline-block border-b-2 text-purple-500 border-purple-500 dark:text-purple-400 dark:border-purple-400 focus:outline-none py-2 px-4">
                            Motifs d'absences
                        </button>
                        <button id="retard" onclick="openTab(event, 'retard')" class="text-sm uppercase font-light flex-1 tablinks inline-block hover:text-purple-500 dark:hover:text-purple-400 focus:outline-none py-2 px-4">
                            Motifs de retards
                        </button>
                        <button id="options" onclick="openTab(event, 'options')" class="text-sm uppercase font-light flex-1 tablinks inline-block hover:text-purple-500 dark:hover:text-purple-400 focus:outline-none py-2 px-4">
                            Options
                        </button>
                        <button id="presence" onclick="openTab(event, 'presence')" class="text-sm uppercase font-light flex-1 tablinks inline-block hover:text-purple-500 dark:hover:text-purple-400 focus:outline-none py-2 px-4">
